...
El DataFrame "datos" tiene 8 variables.

2) ¿Los datos son fácilmente accesibles?
Si, porque si observamos el DF, se ve claramente y a simple vista la información.

3) ¿Que datos podemos observar en este data frame?
En este DF observamos los datos recogidos por sensores que monitorizan el nivel de ruido en diferentes localizaciones del barrio de Ruzafa.

4) ¿Hay datos perdidos?¿Es un analisis univariante o bivariante?
Si que hay datos perdidos, y es un análisis bivariante.
