...
glimpse(datos)
```
¿Cuántas variables o columnas tiene el data frame?.
¿Los datos son fácilmente accesibles?
¿Que datos podemos observar en este data frame?
¿Hay datos perdidios?¿Es un analisis univariante o bivariante?
