...
8) ¿Cómo ha variado el ruido en el 2022 en cada calle?


9) ¿Cuál ha sido el año en el que se ha producido de media más ruido?


10) El nivel sonoro en la tarde-noche representa la molestia que produce, ¿en qué mes hubo mayor malestar en el 2021?¿y en cuál menos?
...
6) El mes que mas ruido hay es Marzo comprobamos en que dias hay mas ruido y durante que hora.
...
8)#
```{r}
datos %>% filter(year=="2022", calle=="Cuba_3") %>% 
  ggplot(aes(x=month, y=Nivel_Sonoro))+geom_point()
```
